...
public class SampleTest {
    ...
    @org.junit.jupiter.api.Test
    void someEqualItems() {
        Assertions.assertArrayEquals(new int[]{1, 1, 3, 4, 5},
                Solution.heapsort(new int[]{1, 4, 3, 5, 1}));
    }

    @org.junit.jupiter.api.Test
    void manyItems() {
        Assertions.assertArrayEquals(new int[]{-4, 1, 2, 3, 4, 5, 44, 54, 333333333},
                Solution.heapsort(new int[]{1, 2, 3, 5, 333333333, 44, 54, -4, 4}));
    }

    @org.junit.jupiter.api.Test
    void negativeItems() {
        Assertions.assertArrayEquals(new int[]{-34939493, -4, -3, -2, 0},
                Solution.heapsort(new int[]{-4, -3, 0, -2, -34939493}));
    }

    @org.junit.jupiter.api.Test
    void someEqualItems2() {
        Assertions.assertArrayEquals(new int[]{1, 1, 3},
    ...
    @org.junit.jupiter.api.Test
    void allEqual() {
        Assertions.assertArrayEquals(new int[]{1, 1, 1, 1, 1},
    ...
    void evenCountOfElements() {
        Assertions.assertArrayEquals(new int[]{1, 1, 2, 2, 3, 5},
